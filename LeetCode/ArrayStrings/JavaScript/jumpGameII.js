...
function testSolution(record) {
  ...
  const result = solution.jump(record.nums);
...
const records = [
  new JumpGameIIRecord([2, 3, 1, 1, 4], 2),
  new JumpGameIIRecord([2, 3, 0, 1, 4], 2),
  new JumpGameIIRecord([0], 0),
  new JumpGameIIRecord([1, 2], 1),
];
