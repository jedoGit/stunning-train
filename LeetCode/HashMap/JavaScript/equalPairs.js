...
function testSolution(record) {
  ...
  const result = solution.equalPairs(cloneGrid(record.grid));
...
const records = [
  new EqualPairsRecord([[3, 2, 1], [1, 7, 6], [2, 7, 7]], 1),
  new EqualPairsRecord([[3, 1, 2, 2], [1, 4, 4, 5], [2, 4, 2, 2], [2, 4, 2, 2]], 3),
];
