...
function testSolution(record) {
  ...
  const result = solution.rob(record.nums);
...
const records = [
  new HouseRobberRecord([1, 2, 3, 1], 4),
  new HouseRobberRecord([2, 7, 9, 3, 1], 12),
  new HouseRobberRecord([5], 5),
  new HouseRobberRecord([2, 1, 1, 2], 4),
  new HouseRobberRecord([0, 0, 0], 0),
];
